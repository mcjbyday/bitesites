...
const CheckOptionItem = ({ option }) => {
    return (
        ...
        style={{ backgroundColor: "var(--darkest)" }} ><Field type="checkbox" name="socialsArray" value={option.buttontext}/>{option.buttontext}
        <img className="h-20 mx-auto my-auto" src={option.piclink}></img></label>
    );
};
