...
export default function downloadFile() {
    ...
    <button style="border-radius:30px;width:180px;" onclick="window.open('${buttondata[i].gotolink}" class="bg-black pop hover:bg-gray-800 text-gray-500 hover:text-gray-400 py-2 px-4 border border-gray-500 hover:border-transparent rounded text-base font-light mt-5 mx-24 platformbuttons displaynone">
